            ...
            <Table responsive>
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('symptoms')}>
                    <Translate contentKey="dhomoniApp.searchDisease.symptoms">Symptoms</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
                    <Translate contentKey="dhomoniApp.searchDisease.dept">Dept</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
              <tbody>
                {diseaseList.map((disease, i) => (
                  <tr key={`entity-${i}`}>
                    ...
                    <td>{disease.dept ? <Link to={`medical-department/${disease.dept.id}`}>{disease.dept.id}</Link> : ''}</td>
