...
import { searchEntity } from './medicine.reducer';
  ...
  render() {
    ...
    return (
      <Row>
        <Col md="8">
          <h2>
            <Translate contentKey="dhomoniApp.searchMedicine.detail.title">Medicine</Translate>
          </h2>
...
const mapStateToProps = ({ searchMedicine }: IRootState) => ({
  medicineEntity: searchMedicine.entity
});
